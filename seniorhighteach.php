...
<head>
  ...
  <title>Seniorhigh Teachers Information</title>
...
<?php include('C:\xampp\htdocs\Prefect\inc\adminsidebar.php'); ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Seniorhigh Teacher Information</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
          <li class="breadcrumb-item ">Information</li>
          <li class="breadcrumb-item active">Seniorhigh Teachers Information</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Seniorhigh Teachers Information</h5>
